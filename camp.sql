...
(4, 'Teen Males', 'Age group of 13-19 years old teenage males'),
(5, 'Teen Females', 'Age group of 13-19 years old teenage females'),
(6, 'Teen Mix', ''),
(7, 'Adult Males', ''),
(8, 'Adult Females', ''),
(9, 'Adult Mix', ''),
...
CREATE TABLE `camp_rating` (
  ...
  `rate_val` enum('1','2','3','4','5') NOT NULL COMMENT 'value for money',
  `rate_acc` enum('1','2','3','4','5') NOT NULL COMMENT 'accomodation and facilities',
  `rate_food` enum('1','2','3','4','5') NOT NULL COMMENT 'food',
...
(5, 'Amit', 'Kashyap', 'abc@gmail.com', '1537c1dea8479ff52bc68336e323385f', '+918287051797', 'Street - 4', 'cansas city', '876543', 'New Jersey', '223', '0000-00-00', '', '', 0, 'eJd1536063410', 1, 2, '2018-09-04 17:46:50', 'Summer Camp Organiser', '<p>We are a <strong>global management</strong> consulting firm that serves a broad mix of private, public and social sector institutions. We help our clients make significant and lasting improvements to their performance and realize their most important <strong>goals.</strong> With nearly a century of experience, we&rsquo;ve built a firm uniquely equipped to this task.</p>\r\n', '5_28092018100602.jpg', 'www.lolwa.com', '', '80_1538121863.jpg', 'Asia Governing Body', 'BR10125-K123', '5_28092018101352.jpg', 0, 'Amitabh Kumar', 'amitabh@langjobs.com', '+908765432190', 'RN2144ZX54', '5_06092018090216.jpg'),
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `google_id` varchar(100) NOT NULL COMMENT 'dont get confused. Any social media id',
  ...
  `social_stat` varchar(50) NOT NULL COMMENT 'if null then it is a regular login else name of the social site ',
