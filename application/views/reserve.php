<script>
   ...
   <div class="wrapper">
    <div class="page-header page-header-small">
      <div class="page-header-image" data-parallax="true" style="background-image: url('<?php echo base_url(); ?>assets/frontend/img/reserve.jpg');">
      </div>
      <div class="content-center">
        <div class="container">
          <h1 class="title">Request Reservation</h1>
        </div>
      </div>
    </div>
    <div class="section">
        <div class="container">
            <h3>Request a reservation: <?php echo $this->input->post('camp_name');  ?></h3>
            <div class="row">
                   ...
                   <div class="alert alert-info" role="alert">
                    ...
                    <div class="alert alert-warning" role="alert">
                      <div class="container">
                        ...
                        <strong>Remember,</strong> Prices are indicative because of various factors. Exact amount desc will be sent to you via email.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          <span aria-hidden="true">
                            <i class="now-ui-icons ui-1_simple-remove"></i>
                          </span>
                    ...
                    <form action="<?php echo base_url() ?>Reserve/save_reservation" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="lname" placeholder="Enter Your Last Name" name="lname" value="<?php if($this->session->userdata('last_name')) echo $this->session->userdata('last_name'); ?>" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select name="number_code" id="" class="form-control">
                          ...
                          <input type="number" class="form-control" placeholder="Enter Phone Number" name="phone" value="" required />
                        </div>
                        <div class="form-group">
                          <label for="persons">No of persons:</label>
                          <input type="number" class="form-control" id="nop" placeholder="Enter number of persons" name="persons" value="" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button class="btn btn-success">Send Request <i class="fas fa-paper-plane"></i></button>
                        </div>
                    </form>
                </div>
                <div class="col-md-2 col-lg-2">&nbsp;</div>
