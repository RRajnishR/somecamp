...
<section id="main-content">
    <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Login Here</h3>
        <div class="row mt">
            <div class="col-lg-12">
                <form class="form-horizontal" role="form" method="post" action="<?php echo base_url()?>camp_admin/Admin/loginValidate">
                    <?php if(!empty($error)) { ?>	
				    ...
				    <div class="form-group">
					  <div class="col-lg-offset-2 col-lg-10">
						  ...
						  <a href="<?php echo base_url();?>camp_admin/Admin/forgotPassword">forgot password?</a>
					  </div>
				    </div>
			  </form>
            </div>
