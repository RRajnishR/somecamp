...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Edit the content of this camp</h3>
        <div class="row mt">
            <!--  DATE PICKERS -->
            <div class="col-lg-12">
                <div class="form-panel">
                    <form action="<?php echo base_url() ?>camp_organiser/Camps/update_camp" class="form-horizontal style-form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <span class="help-block">Help: Please pick from the options and provide further information on basis of your selection. <?php if($this_camp->pickup_service=="2") echo "<b>Price in: ".$this_camp->currency."</b>"; ?> </span>
                            </div>
                        </div>
                        <div class="form-group">
